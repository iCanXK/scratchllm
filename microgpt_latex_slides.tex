...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=west, text=white, font=\bfseries\small] at ([xshift=0.17\paperwidth,yshift=-0.030\paperheight]current page.north west) {Understanding the inner workings of GPT models.};
  ...
  \node[anchor=south east, text=UTDGreen, align=right, font=\large] at ([xshift=-0.07\paperwidth,yshift=0.10\paperheight]current page.south east) {J Zhao};
\end{tikzpicture}
\end{frame}
